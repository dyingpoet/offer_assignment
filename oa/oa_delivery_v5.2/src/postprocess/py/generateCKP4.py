...
#with open('/home/jli21/sams/auction/2014jan/v4/offers.txt','r') as inputObj:
    for line in inputObj:
        ...
        CAMPAIGN_NBR,DEPT_NBR,SUBCLASS_NBR,VAL_OFFER_TYPE_CODE,VAL_OFFER_TYPE_DESC,MDS_FAM_ID,INVESTMENT_CNT,VALUE_AMT,VALUE_PCT,MIN_ITEM_PURCH_QTY,MAX_REDEMPTION_CNT,PACKAGE_CODE,PACKAGE_DESC,VENDOR_FUNDED_IND,COUPON_ITEM_NBR,VAL_ITEM_TYPE_CODE,VAL_ITEM_TYPE_DESC,VALUE_COUPON_NBR,PRVDR_COUPON_NBR,CLUB_AVAIL_IND,FILLER_DATA = line.strip().split('|')
