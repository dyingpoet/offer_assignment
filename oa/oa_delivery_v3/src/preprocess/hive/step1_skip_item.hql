...
--and b.onsite_onhand_qty >0 and b.status in ('A', 'S', 'O')
...
and a.system_item_nbr not in (${hiveconf:inventory_check_skip_item_list})
;
...
--WHERE a.campaign_month='${hiveconf:campaign_month_type}'
WHERE a.campaign_month='${hiveconf:campaign_month}'
and a.system_item_nbr in (${hiveconf:inventory_check_skip_item_list})
;
