...
(
    ...
    (
        ...
        ON (a.preferred_club_nbr = b.club_nbr and a.campaign_month='${hiveconf:campaign_month}' and b.campaign_month='${hiveconf:campaign_month}')
        ...
        ON (a.assigned_club_nbr = b.club_nbr and a.campaign_month='${hiveconf:campaign_month}' and b.campaign_month='${hiveconf:campaign_month}')
    ) a
) a
...
--and a.system_item_nbr = b.system_item_nbr and b.campaign_month='${hiveconf:campaign_month}')
;
