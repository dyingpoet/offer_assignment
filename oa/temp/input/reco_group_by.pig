...
%default subcat_score_input '/user/jli21/pythia/Workspaces/SamsMEP/Recommend/Scoring/ThankYou/2015-06-16/Decay/recommend_score_cobought_no_smoothing_max_cosine_cobought_transaction_debug_adj_study_scaled';
%default subcat_list '/user/pythia/Workspaces/SamsMEP/offerAssignment/2015jul390/subcatList';
%default subcat_score_output '/user/pythia/Workspaces/SamsMEP/offerAssignment/2015jul390/score/reco_subcat_score_grouped_v3';
