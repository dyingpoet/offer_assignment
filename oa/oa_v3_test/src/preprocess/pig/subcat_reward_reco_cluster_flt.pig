...
score0 = FILTER score0 BY score>0;

-- add cluster id
scoreLabelJoin = JOIN score0 BY (membership_nbr,cardholder_nbr,membership_create_date), clusterLabel BY (membership_nbr,cardholder_nbr,membership_create_date) USING 'replicated';

scoreLabel = FOREACH scoreLabelJoin GENERATE 
    score0::membership_nbr AS membership_nbr
    , score0::cardholder_nbr AS cardholder_nbr
    , score0::membership_create_date AS membership_create_date
    , score0::cat_subcat_nbr AS cat_subcat_nbr
    , score0::system_item_nbr AS system_item_nbr
    , score0::value_coupon_nbr AS value_coupon_nbr
    , score0::score AS score
