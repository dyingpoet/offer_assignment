...
scoreJoin = JOIN score BY (cat_subcat_nbr,system_item_nbr), itemGlobalPopularity BY (cat_subcat_nbr,system_item_nbr) PARALLEL 500;
...
scoreFlt = FOREACH scoreJoin GENERATE 
    ...
    , score::score + 1.0 / itemGlobalPopularity::rank * (float) $delta AS score
;
