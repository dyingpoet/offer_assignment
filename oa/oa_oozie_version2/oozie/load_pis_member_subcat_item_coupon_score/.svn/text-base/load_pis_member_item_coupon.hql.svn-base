...
--  Script Name     : load_pis_member_item_coupon.hql
--  Description     : This hql will extracts & loads member detail on item level. 
...
AND a.system_item_nbr = b.system_item_nbr AND b.score_type='${campaign_score_type}');
;
